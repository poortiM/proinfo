								                                ...
								                                <div class="dtls">
								                                    <div class="info"><a class="title pd" rel="author" href="{{url('profile')}}/{{$su->username}}"><span class="n">{{$su->name}} </span></a>
								                                        ...
								                                        <div class="fbtn">
								                                            <div class="tb">
								                                                <div class="w">
								                                                    <div class="rp-follow-btn follow-user" auth_id="{{Auth::guard('web')->user()->id}}" following_id="{{$su->id}}"><span class="t flw follow-response">Following</span></div>
								                                                </div>
								                                            </div>
								                                        </div>
								                                    </div>
