                ...
                <div class="col-md-12 col-sm-12  info-box">
                    <div class="row">
                        <div class="col-md-8 col-sm-12 col-md-offset-2">
                            <div class="col-md-12">
                                <a href="#" class="col-md-6 btn btn-default"> Product Info </a>
                                <a href="#" class="col-md-6 btn btn-info"> Product Photos </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-8 col-sm-12 col-md-offset-2">
                            ...
                            <div class="col-xs-12 mt-10">
                                <a href="{{url('pro/dashboard')}}" type="submit" class="pull-right btn btn-info">Return to dashboard</a>
                                <div class="spacer-50"></div>
                            </div>
                        </div>
                    </div>
